const IMPORTANT_KEYWORDS = /\b(error|failed|failure|exception|todo|fixme|warning|deprecated|security|password|token|api\s?key)\b/i;

function compressGeneric({ stdout, stderr, exitCode }) {
