...
const graph = require('./graph'), impact = require('./impact'), quality = require('./quality'), gitMetrics = require('./git-metrics'), astPatternAnalyzers = require('./ast-patterns'), risk = require('./risk'), queryWinnow = require('./query-winnow'), codingContext = require('./coding-context'), legacy = require('./legacy-core'), readModel = require('./read-model');
